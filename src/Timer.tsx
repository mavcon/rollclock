...
const Timer: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-app-bg-light dark:bg-app-bg-dark text-app-text-primary-light dark:text-app-text-primary-dark flex flex-col items-center justify-between p-1">
